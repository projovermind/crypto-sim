...
export async function PATCH(request: NextRequest) {
  ...
  // 별명 변경
  if ('nickname1' in body) { if (body.nickname1 !== undefined) updateData.nickname1 = body.nickname1 || null }
  if ('nickname2' in body) { if (body.nickname2 !== undefined) updateData.nickname2 = body.nickname2 || null }
  ...
  if (profit1MinSec !== undefined) updateData.profit1MinSec = Number(profit1MinSec)
  if (profit1MaxSec !== undefined) updateData.profit1MaxSec = Number(profit1MaxSec)
  ...
  if (varRoundEnabled !== undefined) updateData.varRoundEnabled = Boolean(varRoundEnabled)
  if (varRoundDecimals !== undefined) updateData.varRoundDecimals = Number(varRoundDecimals)
  if (preEntryCommentMin !== undefined) updateData.preEntryCommentMin = Number(preEntryCommentMin)
  if (preEntryCommentMax !== undefined) updateData.preEntryCommentMax = Number(preEntryCommentMax)
  if (longCommentMin !== undefined) updateData.longCommentMin = Number(longCommentMin)
  if (longCommentMax !== undefined) updateData.longCommentMax = Number(longCommentMax)
  if (shortCommentMin !== undefined) updateData.shortCommentMin = Number(shortCommentMin)
  if (shortCommentMax !== undefined) updateData.shortCommentMax = Number(shortCommentMax)
  if (postEntryCommentMin !== undefined) updateData.postEntryCommentMin = Number(postEntryCommentMin)
  if (postEntryCommentMax !== undefined) updateData.postEntryCommentMax = Number(postEntryCommentMax)
  if (preCloseCommentMin !== undefined) updateData.preCloseCommentMin = Number(preCloseCommentMin)
  if (preCloseCommentMax !== undefined) updateData.preCloseCommentMax = Number(preCloseCommentMax)
  if (closeCommentMin !== undefined) updateData.closeCommentMin = Number(closeCommentMin)
  if (closeCommentMax !== undefined) updateData.closeCommentMax = Number(closeCommentMax)
  if (profit1CommentMin !== undefined) updateData.profit1CommentMin = Number(profit1CommentMin)
  if (profit1CommentMax !== undefined) updateData.profit1CommentMax = Number(profit1CommentMax)
  if (profit2CommentMin !== undefined) updateData.profit2CommentMin = Number(profit2CommentMin)
  if (profit2CommentMax !== undefined) updateData.profit2CommentMax = Number(profit2CommentMax)
  if (channelName !== undefined) updateData.channelName = channelName || null
  if (channelAvatarUrl !== undefined) updateData.channelAvatarUrl = channelAvatarUrl || null
  if (body.channelGeneration !== undefined) updateData.channelGeneration = body.channelGeneration != null ? Number(body.channelGeneration) : null
  if (body.genAutoIncrement !== undefined) updateData.genAutoIncrement = !!body.genAutoIncrement
  if (body.subscriberCount !== undefined) updateData.subscriberCount = Number(body.subscriberCount) || 0
  console.log('[account PATCH] channelGeneration=' + body.channelGeneration + ' subscriberCount=' + body.subscriberCount + ' genAutoIncrement=' + body.genAutoIncrement)
  if (body.subscriberResetDay !== undefined) updateData.subscriberResetDay = body.subscriberResetDay ? new Date(body.subscriberResetDay) : null
  if (body.subscriberLastDaily !== undefined) updateData.subscriberLastDaily = body.subscriberLastDaily ? new Date(body.subscriberLastDaily) : null
  if (teleditTemplateImages !== undefined) updateData.teleditTemplateImages = teleditTemplateImages || null
  ...
  const updated = await prisma.user.update({
    ...
    data: updateData,
    select: { id: true, email: true, name: true, nickname1: true, nickname2: true, role: true, status: true, teledditTemplate: true, teledditLongTemplate: true, teledditShortTemplate: true, teledditEnabled: true, teledditLongEnabled: true, teledditShortEnabled: true, teleditApiUrl: true, teleditEmail: true, teleditPassword: true, teleditCloseTemplate: true, teleditCloseEnabled: true, teleditProfitTemplate: true, teleditProfitEnabled: true, teleditPreEntryTemplate: true, teleditPreEntryEnabled: true, teleditPostEntry1Template: true, teleditPostEntry1Enabled: true, teleditPostEntry2Template: true, teleditPostEntry2Enabled: true, teleditPostEntry3Template: true, teleditPostEntry3Enabled: true, teleditPreCloseTemplate: true, teleditPreCloseEnabled: true, teleditPostClose1Template: true, teleditPostClose1Enabled: true, teleditPostClose2Template: true, teleditPostClose2Enabled: true, teleditPostClose3Template: true, teleditPostClose3Enabled: true, preEntryMinSec: true, preEntryMaxSec: true, preCloseMinSec: true, preCloseMaxSec: true, teleditPostEntryTemplate: true, teleditPostEntryEnabled: true, postEntryMinSec: true, postEntryMaxSec: true, teleditProfitTemplate2: true, teleditProfit2Enabled: true, profit1MinSec: true, profit1MaxSec: true, profit2MinSec: true, profit2MaxSec: true, varRoundEnabled: true, varRoundDecimals: true, preEntryCommentMin: true, preEntryCommentMax: true, longCommentMin: true, longCommentMax: true, shortCommentMin: true, shortCommentMax: true, postEntryCommentMin: true, postEntryCommentMax: true, preCloseCommentMin: true, preCloseCommentMax: true, closeCommentMin: true, closeCommentMax: true, profit1CommentMin: true, profit1CommentMax: true, profit2CommentMin: true, profit2CommentMax: true, channelName: true, channelAvatarUrl: true, teleditTemplateImages: true },
  })
